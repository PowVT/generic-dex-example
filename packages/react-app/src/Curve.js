  ...
  useEffect(() => {
    ...
    if (canvas.getContext && props.ethReserve && props.tokenReserve) {
      ...
      if(props.addingEth){
        ...
        ctx.fillStyle = "#000000";
        ctx.fillText(""+(amountGained)+" ADP output (-0.3% fee)", plotX(newEthReserve)+textSize,plotY(k/(newEthReserve)));
        ...
        ctx.fillStyle = "#000000";
        ctx.fillText(""+(props.addingToken)+" ADP input", plotX(props.ethReserve)+textSize,plotY(props.tokenReserve));
